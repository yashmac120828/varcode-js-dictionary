...
const HomeSection = ({ selectedTopic }) => {
    const content = {
        "JavaScript Basics": "JavaScript is a versatile programming language used for web development.",
        "Introduction": "JavaScript was created to make web pages interactive.",
        "Syntax": "JavaScript syntax defines how programs are written and structured.",
        "Hello World": "console.log('Hello, World!'); prints a message to the console.",
        "JS Variables & Datatypes": "JavaScript supports var, let, and const for variable declarations.",
        "var, let, const": "var is function-scoped, let and const are block-scoped.",
        "Primitive Types": "JavaScript has 7 primitive types: Number, String, Boolean, etc.",
        "Type Conversion": "Converting one type to another, like String to Number.",
        "JS Operators": "JavaScript has arithmetic, logical, and comparison operators.",
        "Arithmetic": "Includes +, -, *, /, and %.",
        "Comparison": "Includes ==, ===, >, <, >=, and <=.",
        "Logical": "Includes &&, ||, and !.",
        "JS Loops": "Loops allow executing code multiple times (for, while, do-while).",
        ...
        "Function Declaration": "A function can be declared using function keyword.",
